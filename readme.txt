...
Dengan menggunakan **JNE Shipping**, maka anda dapat menampilkan daftar ongkos kirim per daerah di Indonesia yang telah ditentukan dan langsung terintegrasi dengan WP-Ecommerce.
...
1. screenshot-1.png Tampilan JNE Shipping pada form Checkout.
2. screenshot-2.png Tampilan Daftar Tarif JNE
2. screenshot-3.png Tampilan Import Tarif from CSV
2. screenshot-4.png Tampilan preview import Tarif.


== Changelog ==

= 1.7 =
- Fix: Beberapa minor error.
- Fix: Import data dalam jumlah besar.

= 1.6 =
- Fix: Import problem.
- Fix: Shipping City field.
- Add: Kosongkan data.
...
= 1.2 =
- Fix: Tidak bisa ubah/hapus data tarif.
